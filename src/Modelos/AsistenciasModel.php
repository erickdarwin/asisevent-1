...
class AsistenciasModel extends Model {
    ...
    /*=============================================
	MODIFICAR CONDICION ASISTENCIA
	=============================================*/
    public function modificarCondicion($condicion,$idAsistencia){
		
		$sql ="UPDATE asistencias SET condicion='$condicion' WHERE id=$idAsistencia ";
		$update = $this->conexion->query($sql); 
		if($update) return true;
		else return false;
		parent::cerrar(); 
    ...
    public function mdlEditarComentar($valor){
        $sql ="SELECT id,justificado FROM asistencias WHERE id = '$valor' ";
		$result = $this->conexion->query($sql); 
        $resultado = $result->fetch_all(MYSQLI_ASSOC); 
        parent::cerrar();
        return $resultado; 
    ...
    public function mdlJustificar($valor1,$valor2){
        $sql ="UPDATE asistencias SET justificado = '$valor1' WHERE id = '$valor2' ";
	...
	JUSTIFICAR
	=============================================*/    
//    public function mdlJustificar($comentario,$ids){
//
//	$sql ="UPDATE asistencias SET justificado='$comentario' WHERE id=$ids ";
//		$update = $this->conexion->query($sql); 
//		if($update) return true;
//		else return false;
//		parent::cerrar();
