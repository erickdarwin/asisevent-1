...
<html lang="es">
  <head>
    <title>SA Virtual</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <link rel="icon" href="../../imagenes/logo/logo-SA.png">
  <!--=====================================
   PLUGINS DE CSS
  ======================================-->
  ...
  <body>
    ...
    <div class="hold-transition sidebar-collapse ">
      ...
      <div class="panel panel-warning">
        ...
        if(isset($_SESSION['mensaje']) or isset($_SESSION['comentario'])){ 	
	       echo "<div class='alert alert-danger'> <center><h3>".$_SESSION['mensaje'].": <small> 
           ".$_SESSION['comentario']."</small></h3></center></div>";
        ...
        <footer class="main-footer">
          ...
          <center>
            <strong>© 2009 Colegio Santa Adriana.</strong> Dirección: Pachacutec 326, Juliaca  
          </center>
