...
require_once "../Controladores/ReporteControl.php";
    ...
    $grupoId = $_POST["tpGrupo"];
    $condicion = $_POST["condicionp"];
    $fecha = $_POST["fecha"];

?>
 
  <table class="table table-bordered table-striped dt-responsive tablas1" style="width: 100%;">
    ...
    <tbody>
      <?php
        ...
        $asistenciaI = $objAsistencia->ctrMostrarAsistencias(2,$periodoId,$grupoId,$condicion,$fecha);
...
=============================================*/
$(".tablas1").on("click", "td .btnJusticar", function(){
...
$(".tablas1").on("click", "td .btnComentario", function(){
